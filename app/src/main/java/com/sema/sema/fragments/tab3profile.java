...
import com.sema.sema.activities.NotificationActivity;
import com.sema.sema.activities.ProfileActivity;
...
public class tab3profile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        openEditProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(new Intent(getActivity(), ProfileActivity.class)));
            }
        });
